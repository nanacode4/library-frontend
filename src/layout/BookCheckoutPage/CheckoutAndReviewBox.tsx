    ...
    function buttonRender(){
        if (props.isAuthenticated) {
            if(!props.isCheckedOut && props.currentLoansCount < 5){
                return (<button onClick={() => props.checkoutBook()} className="btn btn-secondary btn-lg">Checkout</button>)
        ...
        return (<Link to={"/login"} className="btn btn-secondary btn-lg">Sign in</Link>)
    }
        ...
        <div className={props.mobile? "card d-flex mt-5" : "card col-3 container d-flex mb-5"}>
            <div className="card-body container">
                <div className="mt-3">
                    ...
                    :
                    <h4 className="text-warning">Wait List</h4>
                    }
                    <div className="row">
